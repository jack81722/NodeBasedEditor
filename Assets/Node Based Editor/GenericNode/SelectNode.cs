...
namespace NodeEditor.Generic
{
    public class SelectNode : Node
    {
        ...
        public SelectNode(GUIStyle nodeStyle, GUIStyle selectedStyle, GUIStyle inPointStyle, GUIStyle outPointStyle) : base(nodeStyle, selectedStyle, inPointStyle, outPointStyle)
        {
            title = "Select";
            ShowTitle = false;
        ...
        public SelectNode(int id, Vector2 position, GUIStyle nodeStyle, GUIStyle selectedStyle, GUIStyle inPointStyle, GUIStyle outPointStyle) : base(id, position, nodeStyle, selectedStyle, inPointStyle, outPointStyle)
        {
            title = "Select";
            ShowTitle = false;
            AddInPoint<EventConnectPoint>();
