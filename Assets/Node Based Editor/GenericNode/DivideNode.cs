...
namespace NodeEditor.Generic
{
    public class DivideNode : Node
    {
        ...
        public DivideNode(GUIStyle nodeStyle, GUIStyle selectedStyle, GUIStyle inPointStyle, GUIStyle outPointStyle) : base(nodeStyle, selectedStyle, inPointStyle, outPointStyle)
        {
            title = "Divide";
            ShowTitle = false;
        ...
        public DivideNode(int id, Vector2 position, GUIStyle nodeStyle, GUIStyle selectedStyle, GUIStyle inPointStyle, GUIStyle outPointStyle) : base(id, position, nodeStyle, selectedStyle, inPointStyle, outPointStyle)
        {
            title = "Divide";
            ShowTitle = false;
            InPointAlignment = EConnectPointAlignment.Upper;
